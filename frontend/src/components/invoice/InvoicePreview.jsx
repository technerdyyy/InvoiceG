      ...
      <div className="border-2 border-gray-200 rounded-lg p-6">
        ...
        <div className="flex justify-between mb-6">
          <div className="w-1/2">
            ...
            <div className="text-sm space-y-1">
              ...
              <p className="text-blue-600">
                {invoice.referenceNumber || "[Reference Number]"}
              </p>
              <p className="text-blue-600">
                {invoice.contactInfo || "[Contact Information]"}
              </p>
              <p className="text-blue-600">
                Service/Product: {invoice.serviceDescription || "[Description]"}
              </p>
              <p className="text-blue-600">
        ...
        <div className="border border-gray-300 rounded">
          ...
          {invoice.items.map((item) => (
            <div
              key={item.id}
              className="grid grid-cols-4 gap-4 p-3 border-b last:border-b-0 text-sm"
            >
        ...
        <div className="mt-6 text-xs text-gray-600">
          <p>
            Payment terms: {invoice.terms || "[specify terms]"}. Please
